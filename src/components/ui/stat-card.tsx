...
export function StatCard({
  ...
  return (
    <div className="rounded-lg border border-border bg-card p-[var(--card-pad)] shadow-none">
      <div className="flex items-start justify-between">
        <div className="space-y-1">
          <p className="text-sm font-medium text-muted-foreground">{title}</p>
          <p className="text-[1.6875rem] font-semibold tabular-nums text-foreground">{value}</p>
