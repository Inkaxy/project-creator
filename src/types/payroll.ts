...
export const SALARY_CATEGORIES: Array<{
  ...
  { value: 'monthly', label: 'Månedslønn', color: 'bg-ai-light text-ai border border-ai-border' },
  ...
  { value: 'bonus', label: 'Bonus', color: 'bg-ai-light text-ai border border-ai-border' },
